...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "jeliyanr@gmail.com", path: '/', icon: MailIcon },
                { text: "7628012926", path: '/', icon: PhoneIcon },
                { text: "Tripura, 799271", path: '/', icon: MapPinIcon }
            ]
        }
    ];

    const socialIcons = [
        { icon: FacebookIcon, link: "https://m.facebook.com/jeliyan.reang.5/" },
        { icon: InstagramIcon, link: "https://www.instagram.com/im.jr077/" },
        { icon: TwitterIcon, link: "https://x.com/reang_jeliyan" },
        { icon: LinkedinIcon, link: "www.linkedin.com/in/jeliyan-reang-055332324" },
    ]
